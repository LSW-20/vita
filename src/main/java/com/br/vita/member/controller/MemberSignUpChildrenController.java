 ...
 */
@WebServlet("/signUp_children.me")
public class MemberSignUpChildrenController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberSignUpChildrenController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Member m = new Member(userId, userPwd, userName, phone, email, address, userSSN, callbackYN, userDate, gender, rep);
		
		System.out.println("가져온값 : " + m);
		
		// 서비스 호출 (쿼리실행)
		int result = new MemberService().signUpChildrenMember(m);
