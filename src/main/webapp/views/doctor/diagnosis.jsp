	...
	<div class="container mt-5">
		...
		<div class="userSelectDiv">
			<div class="userSelName">
				<span class="userSel-1" id="userName">환자이름</span> <span
					class="userSel-1" id="department">진료과</span>
			</div>
			<div id="userNumbers">
				<br>
				<div id="user_no_div">
					<b>병원등록번호 :</b> <span id="user_no_value" class="text_value"></span>
				</div>
				<br>
				<div id="user_ssn_div">
					<b>주민번호 : </b><span id="user_ssn_value" class="text_value"></span>
				</div>
				<br>
				<div id="user_phone_div">
					<b>전화번호 : </b><span id="user_phone_value" class="text_value"></span>
				</div>
				<br>
			</div>
		</div>
		...
		<div id="table-container">
			<table class="table table-bordered" id="docuTable">
				...
				<tr class="tr_click">
					<td id=""><%= m.getUserNo() %> <input type="hidden"
						value="<%= m.getCareNo() %>" class="care_no_data1"> <input
						type="hidden" value="<%= m.getUserNo() %>" class="user_no_data1">
					</td>
											...
											<div class="table_div">
												...
												<div class="modal-footer">
													<button type="button" class="btn btn-success"
														data-dismiss="modal" id="yes_btn1" onclick="fnYes();"
														data-care-no="<%= m.getCareNo() %>">승인</button>

													<button type="button" class="btn btn-danger"
														data-dismiss="modal" id="no_btn1" onclick="fnNo();"
			...
			<nav aria-label="Page navigation example" id="pageBar">
				<ul class="pagination" style="margin-left: 88px;">
					...
					<li
						...
						<a class="page-link"
							href="<%= contextPath %>/dia_list.do?page=<%=pi.getCurrentPage()-1%>&type=진단서">
					...
					<li class='page-item <%=p == pi.getCurrentPage() ? "active" : ""%>'>
						<a href='<%= contextPath %>/dia_list.do?page=<%=p%>&type=진단서'
						class="page-link"><%= p %></a>
					</li>
					<%} %>
