...
<div style="width: 100%; max-width: 800px; margin: 0 auto;">
    <h1 style="text-align: center; font-size: 24px;">입퇴원 확인서</h1>

    <table border="1" cellspacing="0" cellpadding="10" style="width: 100%; border-collapse: collapse; margin-top: 20px; font-size: 14px;">
        <tr>
            <td style="width: 20%;"><b>환자의 성명</b></td>
            <td style="width: 80%;"><%= loginUser.getUserName() %></td>
        </tr>
        <tr>
            <td><b>병원등록번호</b></td>
        ...
        <tr>
            <td><b>입원확인</b></td>
            <td><%= loginUser.getUserName() %>님의 입원 사실을 확인합니다.</td>
        </tr>
        <tr>
            <td><b>발급일</b></td>
            <td><%= documents.getApplyDate() %></td>
        </tr>
    </table>
</div>
<div style="margin-top: 20px; width: 100%; max-width: 800px; margin: 0 auto;">
    <p>[의료법] 제 17 조 및 같은 법 시행규칙 제9조1항에 따라 처방 사실을 위와 같이 확인합니다.</p>
