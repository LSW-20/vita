...
<section class="row m-3" style="min-height: 500px;">
  <div class="container border m-4 p-5 rounded" style="height: 800px;">
    ...
    <div class="d-flex justify-content-end">
      ...
      <a href="/vita/views/admin/manageNoticeModify.jsp" class="btn btn-primary btn-sm">수정하기 페이지로</a> &nbsp;
      <a href="" class="btn btn-danger btn-sm">삭제하기</a> &nbsp;
      <!-- ------------------------------------------------------------------------- -->
      <a href="/vita/views/admin/manageNotice.jsp" class="btn btn-warning btn-sm">목록가기</a>
    </div>
    ...
    <table class="table m-4">
      ...
      <tr>
        <th>내용</th>
        <td><p style="min-height:200px;">기존 공지사항 내용</p></td>
      </tr>
    </table>
