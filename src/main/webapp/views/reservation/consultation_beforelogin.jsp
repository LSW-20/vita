      ...
      <div class="container11">
        ...
        <div class="container11">
          <div class="d-flex" style="margin-left: 65px;">  
            <div class="p-2" style="margin-top: 70px; margin-left: 70px">
              <img src="/vita/assets/image/마이페이지.jpg"  class="img-check" id="img1"><br>
              <h3 style="margin-top: 30px; margin-left:70px">마이페이지</h3>
            </div>
            
            <div id="vertical-line" style="margin-left:100px; margin-top: 40px;"></div>
            
            <div class="p-2" style="margin-top: 70px; margin-left: 90px">
              <img src="/vita/assets/image/층별안내.jpg"  class="img-check" id="img1">
              <h3 style="margin-top: 30px; margin-left:85px">층별 안내</h3>
            ...
            <div class="p-2" style="margin-top: 70px; margin-left: 90px">
              <img src="/vita/assets/image/의료진료과.jpg"  class="img-check" id="img1">
              <h3 style="margin-top: 30px; margin-left:50px">의료진/진료과</h3>
            </div>
            
            <div id="vertical-line" style="margin-left:100px; margin-top: 40px;"></div>
            
            <div class="p-2" style="margin-top: 70px; margin-left: 70px">
              <img src="/vita/assets/image/오시는길.jpg" class="img-check" id="img1">
              <h3 style="margin-top: 30px; margin-left:80px">오시는길</h3>
            </div>
          </div>
        </div> 
        ...
        <!-- 줄 -->
         ...
         <div class="container11 p-3 my-3" style= "background-color: #3A52CF; color:white">
          <h1 style="margin-top: 50px; margin-left:50px">인터넷 예약이 어려우신가요? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전화문의 1234-5678</h1>  
          
          <br><br><br><br><br>
          <h3 style="color:#9395C7; margin-left:50px">·  대표 번호로 연락주시면 상담원이 예약을 도와드립니다. (평일: 오전 8시 30분 ~ 오후 5시 / 토요일: 오전 8시 30분 ~ 오후 12시)</h3><br>
