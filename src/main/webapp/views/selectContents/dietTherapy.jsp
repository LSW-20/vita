    ...
    <section>
        ...
        <div class="container" id="wrap">
          ...
          <div class="text-overlay" style="top: 190px; left: 25px;">
            <a href="<%= contextPath %>/therapy1.do"><b>후천성면역결핍증식</b></a><br>
            <p>비타병원 영양팀</p>
          </div>
          ...
          <div class="text-overlay" style="top: 190px; left: 246px;">
            <a href="<%= contextPath %>/therapy2.do"><b>후두암식</b></a><br>
            <p>비타병원 영양팀</p>
          </div>
          ...
          <div class="text-overlay" style="top: 190px; left: 466px;">
            <a href="<%= contextPath %>/therapy11.do"><b>패혈증식</b></a><br>
            <p>비타병원 영양팀</p>
          </div>
          ...
          <div class="text-overlay" style="top: 190px; left: 688px;">
            <a href="<%= contextPath %>/therapy12.do"><b>저퓨린식</b></a><br>
            <p>비타병원 영양팀</p>
          </div>
        </div>
        <br><br>
        <div class="container" style="width: 1100px; height: 2200px; padding: 0;">
          ...
          <div class="container border-bottom" style="width: 933px; height: 190px; display: flex; margin-left: 20px;">
            ...
            <div class="container" style="width: 80%; height: 170px; margin-left: 10px;">
              ...
              <a href="<%= contextPath %>/therapy3.do"><b>화상식</b></a><br>
              <p>
          ...
          <div class="container border-bottom" style="width: 933px; height: 190px; display: flex; margin-left: 20px;">
            ...
            <div class="container" style="width: 80%; height: 170px; margin-left: 10px;">
              ...
              <a href="<%= contextPath %>/therapy4.do"><b>호모시스틴뇨증식</b></a><br>
              <p>
          ...
          <div class="container border-bottom" style="width: 933px; height: 190px; display: flex; margin-left: 20px;">
            ...
            <div class="container" style="width: 80%; height: 170px; margin-left: 10px;">
              ...
              <a href="<%= contextPath %>/therapy5.do"><b>협심증식</b></a><br>
              <p>
          ...
          <div class="container border-bottom" style="width: 933px; height: 190px; display: flex; margin-left: 20px;">
            ...
            <div class="container" style="width: 80%; height: 170px; margin-left: 10px;">
              ...
              <a href="<%= contextPath %>/therapy6.do"><b>허혈성심장질환식</b></a><br>
              <p>
          ...
          <div class="container border-bottom" style="width: 933px; height: 190px; display: flex; margin-left: 20px;">
            ...
            <div class="container" style="width: 80%; height: 170px; margin-left: 10px;">
              ...
              <a href="<%= contextPath %>/therapy7.do"><b>항문암식</b></a><br>
              <p>
          ...
          <div class="container border-bottom" style="width: 933px; height: 190px; display: flex; margin-left: 20px;">
            ...
            <div class="container" style="width: 80%; height: 170px; margin-left: 10px;">
              ...
              <a href="<%= contextPath %>/therapy8.do"><b>프로피온산혈증, 프로피온산증</b></a><br>
              <p>
          ...
          <div class="container border-bottom" style="width: 933px; height: 190px; display: flex; margin-left: 20px;">
            ...
            <div class="container" style="width: 80%; height: 170px; margin-left: 10px;">
              ...
              <a href="<%= contextPath %>/therapy9.do"><b>프라더 월리 증후군식</b></a><br>
              <p>
          ...
          <div class="container border-bottom" style="width: 933px; height: 190px; display: flex; margin-left: 20px;">
            ...
            <div class="container" style="width: 80%; height: 170px; margin-left: 10px;">
              ...
              <a href="<%= contextPath %>/therapy10.do"><b>폐렴식</b></a><br>
              <p>
