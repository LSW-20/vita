	...
	<section>
     <nav>
       <div>
           ...
           <p class="title3">아이디를 잊어버리셨나요? 해외/국내에 거주중인 회원은 이메일 인증을 통해서 확인 가능합니다.<br>
             </p>
       </div>
       <div class="box1">
         ...
         <a href="<%= contextPath %>/idfind.sd"><button type="button" id="select" class="btn btn-primary">선택</button></a>
       </div>
