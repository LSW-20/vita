...
<body>
	<%@ include file="/views/common/header.jsp" %>
       ...
       <nav>
         <div>
             <p class="title1"><strong>아이디 찾기</strong></p>
             <p class="title3">아이디를 확인하시고 로그인 해주시기 바랍니다.</p>
         </div>
         <div class="box1">
           <p class="e-mail1"><strong>회원 가입 시 등록하신 e-mail로 해당 아이디를 전송하였습니다.</strong></p>
           <p class="e-mail2">e-mail<span class="etc">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;aaa****
