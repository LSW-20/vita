       ...
       <nav>
         <form action="">
            <div class="container11">
               ...
               <img src="/vita/assets/image/검색버튼2.png" alt="돋보기 아이콘">검색</button></a>
            	</div>
            </div>
            <div class="container12">
                <div class="card1">
                  <img class="card-img-top" src="/vita/assets/image/시우.jpg" alt="Card image" style="width:300px;">
		            ...
		            <div class="card4">
		              <img class="card-img-top" src="/vita/assets/image/준수님.jpg" alt="Card image" style="width:300px; height: 400px;">
		                <div class="card-body" style="background-color: #c6dbf0; height: 300px;">
