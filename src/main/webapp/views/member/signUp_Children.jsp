...
%>
	<section>
      	...
      	<p class="title1">
					...
					<table class="table table-borderless">
						...
						<tbody id="hpCheck">
							<tr>
								...
								<td colspan="2"><input type="text" id="phoneInput" class="name" name="phoneInput" maxlength="13" >
			...
			<form name="signUpForm" id="signup-form" action="<%=contextPath%>/signUp_children.me" method="POST" onsubmit="return validateForm()">
				...
				<div style="margin-top: 50px;">
					<p class="title1">
						<strong>만 14세 미만 회원 정보(진료받을 환아)</strong>
					</p>
					<p class="title2" style="width: 200px;">* 필수입력항목</p>
					<div class="container123 form-group">
						<table class="table table-borderless">
			    ...
			    <div class="modal-dialog modal-lg">
			      <div class="modal-content">
			        ...
			        <div class="modal-footer">
			       	  <button type="button" class="btn btn-primary" onclick="modalClear()">완료</button>
      ...
      <style>
        ...
        document.querySelector("#hpCheck input[name=phone]").prop('readonly', false);
      }
